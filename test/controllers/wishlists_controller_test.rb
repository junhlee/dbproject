...
class WishlistsControllerTest < ActionController::TestCase
  ...
  test "should create wishlist" do
    assert_difference('Wishlist.count') do
      post :create, wishlist: { created_at: @wishlist.created_at, customer_id: @wishlist.customer_id, number_of_products: @wishlist.number_of_products, title: @wishlist.title, updated_at: @wishlist.updated_at }
    end
  ...
  test "should update wishlist" do
    patch :update, id: @wishlist, wishlist: { created_at: @wishlist.created_at, customer_id: @wishlist.customer_id, number_of_products: @wishlist.number_of_products, title: @wishlist.title, updated_at: @wishlist.updated_at }
    assert_redirected_to wishlist_path(assigns(:wishlist))
  end
